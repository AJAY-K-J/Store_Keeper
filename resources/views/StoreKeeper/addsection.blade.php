    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 bold"><h5 class="card-title mb-0">SECTIONS LIST</h5></div>
                        <div class="col-md-6 text-end"><button type="submit" class="btn btn-sm btn-success text-end " name="">Add New Section</button></div>
                    </div>
