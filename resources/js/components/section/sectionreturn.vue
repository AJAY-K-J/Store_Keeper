<template>
  <div class="card">
    ...
    <table class="table text-center">
      ...
      <tbody>
        <tr v-for="stock in depreciated_stock" :key="stock.id">
          ...
          <td>
            <button
             type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#viewstock"
...
<!-- Modal -->
<div class="modal fade" id="viewstock" tabindex="-1" role="dialog" aria-labelledby="viewstockTitle" aria-hidden="true">
 ...
 this. get_depreciated_stock();
  ...
  methods: {
   ...
   view_depreciated_stock(stock) {
    ...
    get_depreciated_stock() {
      axios
        .get("/depreciateddetails")
