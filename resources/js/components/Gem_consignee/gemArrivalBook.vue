<template>
  <div class="card">
    ...
    <table class="table text-center">
      ...
      <tbody>
        <tr v-for="GemArrival in GemArrival_details" :key="GemArrival.id">
          ...
          <td v-if="(GemArrival.gemstatus == 1)"><span class="gemstatusApproved">Approved</span></td>
          <td>
            <button
              type="button"
...
export default {
  ...
  methods: {
    ...
    get_GemArrival_details() {
      axios
        .get("/GemArrival-details")
