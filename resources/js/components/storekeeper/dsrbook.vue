<template>
  <div class="card">
    ...
    <table class="table text-center">
      ...
      <tbody>
        <tr v-for="stocks in dsr_stocks" :key="stocks.id">
 ...
 <td>{{ stocks.invoice }}</td>
     ...
     <td>{{ stocks.price }}</td>
          ...
          <td>
            <button
             type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target=".viewdsr"
...
<div class="modal fade viewdsr" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
