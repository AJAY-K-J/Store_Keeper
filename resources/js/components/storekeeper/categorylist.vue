<template >
  <div class="card">
        ...
        <tr v-for="cat in category" :key="cat.id">
          ...
          <td>
           ...
           <i class=" fas fa-edit"> </i>
            ...
            <button class="btn btn-light btn-sm m-0" @click="delete_category(cat.id)"><i class=" fas fa-trash"> </i></button></td>
    ...
    <div class="modal fade" id="edit-category" data-backdrop="static" tabindex="-1" role="dialog"
